  ...
  <div class="login-container">
    <el-form class="login-form" autoComplete="on" label-position="left">
      ...
      <el-form-item prop="password">
        <el-input name="password" :type="passwordType" @keyup.enter.native="handleLogin" v-model="user.password"
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      //   that.now = sessionStorage.getItem("a");
      // }, 3000)
      // this.now = sessionStorage.getItem("a");
    },
    methods: {
      handleLogin() {
        ...
        sessionStorage.setItem('routes', JSON.stringify(admin_data))
